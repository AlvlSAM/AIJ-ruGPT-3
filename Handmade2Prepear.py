...
PATHRUS_SAVE = './Dataset/Compile_data/Compile/Rus_Compile.txt'
PATHSS_SAVE = './Dataset/Compile_data/Compile/Social_studies_Compile.txt'
PATHLIT_SAVE = './Dataset/Compile_data/Compile/Lit_Compile.txt'
PATHHIS_SAVE = './Dataset/Compile_data/Compile/History_Compile.txt'
